...
class ContratoServidorSindicatoModel extends AbstractModel
{
    ...
    public function __construct(ORM\EntityManager $entityManager)
    {
        ...
        $this->repository = $this->entityManager->getRepository("CoreBundle:Pessoal\\ContratoServidorSindicato");
    }
