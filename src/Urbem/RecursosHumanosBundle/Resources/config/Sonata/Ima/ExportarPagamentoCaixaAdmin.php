...
class ExportarPagamentoCaixaAdmin extends AbstractSonataAdmin
{
    ...
    const TIPO_MOVIMENTO_DEBITO_CREDITO_NORMAL = 0;
    const TIPO_MOVIMENTO_CANCELAMENTO = 1;
    const TIPO_MOVIMENTO_CADASTRO_DE_OPTANTES = 5;
    const TIPOS_MOVIMENTO = [
        self::TIPO_MOVIMENTO_DEBITO_CREDITO_NORMAL => 'Débito/Crédito Normal',
        self::TIPO_MOVIMENTO_CANCELAMENTO => 'Cancelamento',
        self::TIPO_MOVIMENTO_CADASTRO_DE_OPTANTES => 'Cadastro de Optantes',
    ];

    const COD_CONFIGURACAO_DESDOBRAMENTO_13_SALARIO = 3;

    protected $baseRouteName = 'urbem_recursos_humanos_ima_exportar_pagamento_caixa';
    protected $baseRoutePattern = 'recursos-humanos/informacoes/exportar-pagamentos/caixa';
    protected $includeJs = [
        '/administrativo/javascripts/administracao/atributo-dinamico-component.js',
        '/recursoshumanos/javascripts/ima/exportar-pagamento-caixa.js'
    ];
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $fieldOptions['tipoCadastro'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.cadastro',
        ];
        ...
        $fieldOptions['competencia'] = [
            'mapped' => false,
            'required' => true,
            'label' => 'label.imaExportarPagamentoCaixa.competencia',
        ];
        ...
        $fieldOptions['tipoFolha'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.tipoCalculo',
        ];
        ...
        $fieldOptions['folhaComplementar'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.folhaComplementar',
        ];
        ...
        $fieldOptions['desdobramento'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.desdobramento',
        ];
        ...
        $fieldOptions['tipoFiltro'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.tipoFiltro',
        ];
        ...
        $fieldOptions['matricula'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.matricula',
        ];
        ...
        $fieldOptions['cgm'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.cgm',
        ];
        ...
        $fieldOptions['lotacao'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.lotacao',
        ];
        ...
        $fieldOptions['local'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.local',
        ];
        ...
        $fieldOptions['codEstagio'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.codigoEstagio',
        ];
        ...
        $fieldOptions['cgmDependente'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.cgmDependente',
        ];
        ...
        $fieldOptions['cgmServidorDependente'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.cgmServidorDependente',
        ];
        ...
        $fieldOptions['valoresLiquidosDe'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.filtrarValoresLiquidosDe',
        ];
        ...
        $fieldOptions['valoresLiquidosAte'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.filtrarValoresLiquidosAte',
        ];
        ...
        $fieldOptions['percentualAPagar'] = [
            ...
            'required' => false,
            'data' => 100,
            'label' => 'label.imaExportarPagamentoCaixa.percentualAPagar',
        ];
        ...
        $fieldOptions['codConvenio'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.codConvenio',
        ];
        ...
        $fieldOptions['codAgencia'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.codAgencia',
        ];
        ...
        $fieldOptions['codContaCorrente'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.codContaCorrente',
        ];
        ...
        $fieldOptions['dtGeracaoArquivo'] = [
            ...
            'format' => 'dd/MM/yyyy',
            'required' => true,
            'label' => 'label.imaExportarPagamentoCaixa.dtGeracaoArquivo',
        ];
        ...
        $fieldOptions['dtPagamento'] = [
            ...
            'format' => 'dd/MM/yyyy',
            'required' => true,
            'label' => 'label.imaExportarPagamentoCaixa.dtPagamento',
        ];

        $fieldOptions['tipoMovimento'] = [
            'mapped' => false,
            'choices' => array_flip($this::TIPOS_MOVIMENTO),
            'choice_label' => function ($key, $value) {
                return sprintf('%d - %s', $key, $value);
            },
            'label' => 'label.imaExportarPagamentoCaixa.tipoMovimento',
        ];

        $fieldOptions['numeroSequencialArquivo'] = [
            'mapped' => false,
            'data' => $repository->fetchNumSequencialArquivo($this->getExercicio()),
            'label' => 'label.imaExportarPagamentoCaixa.numeroSequencialArquivo',
        ];

        $fieldOptions['incluirMatricula'] = [
            'mapped' => false,
            'label' => false,
            'template' => 'RecursosHumanosBundle::Ima/ExportarPagamentoCaixa/incluir_matricula.html.twig',
            'data' => [],
        ];
        ...
        $fieldOptions['listaMatriculas'] = [
            'mapped' => false,
            'label' => false,
            'template' => 'RecursosHumanosBundle::Ima/ExportarPagamentoCaixa/lista_matriculas.html.twig',
            'data' => [],
        ];
        ...
        $fieldOptions['incluirCgmMatricula'] = [
            'mapped' => false,
            'label' => false,
            'template' => 'RecursosHumanosBundle::Ima/ExportarPagamentoCaixa/incluir_cgm_matricula.html.twig',
            'data' => [],
        ];
        ...
        $fieldOptions['listaCgmMatriculas'] = [
            'mapped' => false,
            'label' => false,
            'template' => 'RecursosHumanosBundle::Ima/ExportarPagamentoCaixa/lista_cgm_matriculas.html.twig',
            'data' => [],
        ];
        ...
        $fieldOptions['incluirCodEstagio'] = [
            'mapped' => false,
            'label' => false,
            'template' => 'RecursosHumanosBundle::Ima/ExportarPagamentoCaixa/incluir_cod_estagio.html.twig',
            'data' => [],
        ];
        ...
        $fieldOptions['listaCodEstagios'] = [
            'mapped' => false,
            'label' => false,
            'template' => 'RecursosHumanosBundle::Ima/ExportarPagamentoCaixa/lista_cod_estagios.html.twig',
            'data' => [],
        ];
        ...
        $fieldOptions['incluirCgmDependente'] = [
            'mapped' => false,
            'label' => false,
            'template' => 'RecursosHumanosBundle::Ima/ExportarPagamentoCaixa/incluir_cgm_dependente.html.twig',
            'data' => [],
        ];
        ...
        $fieldOptions['listaCgmDependentes'] = [
            'mapped' => false,
            'label' => false,
            'template' => 'RecursosHumanosBundle::Ima/ExportarPagamentoCaixa/lista_cgm_dependentes.html.twig',
            'data' => [],
        ];
        ...
        $fieldOptions['incluirCgmServidorDependente'] = [
            'mapped' => false,
            'label' => false,
            'template' => 'RecursosHumanosBundle::Ima/ExportarPagamentoCaixa/incluir_cgm_servidor_dependente.html.twig',
            'data' => [],
        ];
        ...
        $fieldOptions['listaCgmServidorDependentes'] = [
            'mapped' => false,
            'label' => false,
            'template' => 'RecursosHumanosBundle::Ima/ExportarPagamentoCaixa/lista_cgm_servidor_dependentes.html.twig',
            'data' => [],
        ];
        ...
        $fieldOptions['atributosDinamicos'] = [
            'mapped' => false,
            'label' => false,
            'template' => 'RecursosHumanosBundle::Ima/ExportarPagamentoCaixa/atributos_dinamicos.html.twig',
            'data' => [],
        ];
        ...
        $fieldOptions['agrupamentoAtributoDinamicoEstagiario'] = [
            ...
            'label' => 'label.imaExportarPagamentoCaixa.agrupamento',
        ];

        $convenio = $repository->fetchGrupoDeContas();
        if ($convenio) {
            $fieldOptions['codConvenio']['data'] = $convenio['cod_convenio_banco'];
            $fieldOptions['codBanco']['data'] = $convenio['cod_banco'];
            $fieldOptions['codAgencia']['data'] = sprintf('%d - %s', $convenio['num_agencia'], $convenio['nom_agencia']);
            $fieldOptions['codContaCorrente']['data'] = $convenio['num_conta_corrente'];
        }

        $formMapper
            ->with('label.imaExportarPagamentoCaixa.cabecalhoFiltro')
            ...
            ->end()
            ->with('label.imaExportarPagamentoCaixa.cabecalhoAtivos')
            ...
            ->end()
            ->with('label.imaExportarPagamentoCaixa.cabecalhoInformacoesGerais')
                ...
                ->add('codBanco', 'hidden', $fieldOptions['codBanco'])
                ->add('codAgencia', 'text', $fieldOptions['codAgencia'])
                ->add('codContaCorrente', 'text', $fieldOptions['codContaCorrente'])
                ->add('dtGeracaoArquivo', 'datepkpicker', $fieldOptions['dtGeracaoArquivo'])
                ->add('dtPagamento', 'datepkpicker', $fieldOptions['dtPagamento'])
                ->add('tipoMovimento', 'choice', $fieldOptions['tipoMovimento'])
