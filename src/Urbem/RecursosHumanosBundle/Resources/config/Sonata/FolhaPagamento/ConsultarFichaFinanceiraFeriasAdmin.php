...
class ConsultarFichaFinanceiraFeriasAdmin extends ConsultarFichaFinanceiraAdmin
{
    protected $baseRouteName = 'urbem_recursos_humanos_folha_pagamento_consulta_ficha_financeira_ferias';
    protected $baseRoutePattern = 'recursos-humanos/folha-pagamento/consulta-ficha-financeira-ferias';

    protected $includeJs = [
        '/recursoshumanos/javascripts/folhapagamento/dataGridConsultaFichaFinanceiraFerias.js'
    ];
