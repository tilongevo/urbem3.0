...
class ConsultarFichaFinanceiraDecimoAdmin extends ConsultarFichaFinanceiraAdmin
{
    protected $baseRouteName = 'urbem_recursos_humanos_folha_pagamento_consulta_ficha_financeira_decimo';
    protected $baseRoutePattern = 'recursos-humanos/folha-pagamento/consulta-ficha-financeira-decimo';

    protected $includeJs = [
        '/recursoshumanos/javascripts/folhapagamento/dataGridConsultaFichaFinanceiraDecimo.js'
    ];
