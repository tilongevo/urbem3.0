...
class ConsultarFichaFinanceiraSalarioAdmin extends ConsultarFichaFinanceiraAdmin
{
    protected $baseRouteName = 'urbem_recursos_humanos_folha_pagamento_consulta_ficha_financeira_salario';
    protected $baseRoutePattern = 'recursos-humanos/folha-pagamento/consulta-ficha-financeira-salario';

    protected $includeJs = [
        '/recursoshumanos/javascripts/folhapagamento/dataGridConsultaFichaFinanceiraSalario.js'
    ];
