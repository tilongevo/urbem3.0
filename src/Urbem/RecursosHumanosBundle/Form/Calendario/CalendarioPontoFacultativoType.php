...
class CalendarioPontoFacultativoType extends AbstractType
{
    /**
        ...
        $builder
            ->add(
                ...
                array (
                  ...
                  "label" => "label.calendario_ponto_facultativo.codFeriado",
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Urbem\CoreBundle\Entity\Calendario\CalendarioPontoFacultativo'
        ));
    }
}
