...
class FaixaTurnoType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('horaEntrada', TextType::class);
        $builder->add('horaSaida', TextType::class);
        $builder->add('horaEntrada2', TextType::class);
        $builder->add('horaSaida2', TextType::class);
    }
