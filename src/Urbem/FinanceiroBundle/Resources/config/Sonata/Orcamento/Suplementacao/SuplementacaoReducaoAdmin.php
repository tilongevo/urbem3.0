...
class SuplementacaoReducaoAdmin extends AbstractSonataAdmin
{
    protected $baseRouteName = 'urbem_orcamento_suplementacao_reducao';
    protected $baseRoutePattern = 'orcamento/suplementacao-reducao';
