...
class DemonstrativoMutacoesPatrimonioLiquidoReportAdmin extends AbstractSonataAdmin
{
    protected $baseRouteName = 'urbem_financeiro_contabilidade_relatorio_demonstrativo_mutacoes_patrimonio_liquido';
    protected $baseRoutePattern = 'financeiro/contabilidade/relatorios/demonstrativo-mutacoes-patrimonio-liquido';
    protected $layoutDefaultReport = '/bundles/report/gestaoFinanceira/fontes/RPT/contabilidade/report/design/mutacoesPatrimonioLiquido.rptdesign';
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ->with('label.contabilidade.relatorios.mutacoesPatrimonioLiquido')
            ->add(
                'exercicio',
                'hidden',
                array(
    ...
    public function prePersist($object)
    {
        ...
        $data = $this->getTranslator()->trans('label.contabilidade.relatorios.dataEmissao').' '.date("d/m/Y").' ';
        $hora = $this->getTranslator()->trans('label.contabilidade.relatorios.horaEmissao').' '.date("H:i");
        ...
        $fileName = $this->parseNameFile("demonstMutacoesPatrimonioLiquido");
        ...
        $params = [
            ...
            'inCodRelatorio' => Relatorio::DEMONST_MUTACOES_PATRIMONIO_LIQUIDO,
