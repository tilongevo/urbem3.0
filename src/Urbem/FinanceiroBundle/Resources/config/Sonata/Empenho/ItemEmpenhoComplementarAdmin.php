...
class ItemEmpenhoComplementarAdmin extends AbstractAdmin
{
    protected $baseRouteName = 'urbem_financeiro_empenho_item_empenho_complementar';
    protected $baseRoutePattern = 'financeiro/empenho/item-empenho-complementar';
    ...
    public function prePersist($object)
    {
        ...
        ->getUltimoNumItem($codPreEmpenho->getCodPreEmpenho(), $this->getExercicio());
    ...
    public function postPersist($object)
    {
        ...
        (new \Urbem\CoreBundle\Model\Empenho\ItemPreEmpenhoModel($entityManager))->afterEmpenhoDiversos($object);

        $this->redirectToUrl('/financeiro/empenho/emitir-empenho-complementar/' . $codPreEmpenhoComposite . '/show');
    }
    ...
    public function postUpdate($object)
    {
        ...
        (new \Urbem\CoreBundle\Model\Empenho\ItemPreEmpenhoModel($entityManager))->updateEmpenhoDiversos($object);
