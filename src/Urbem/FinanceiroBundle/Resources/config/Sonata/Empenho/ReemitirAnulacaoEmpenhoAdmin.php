...
class ReemitirAnulacaoEmpenhoAdmin extends AbstractAdmin
{
    protected $baseRouteName = 'urbem_financeiro_empenho_reemitir_anulacao_empenho';
    protected $baseRoutePattern = 'financeiro/empenho/reemitir-anulacao-empenho';
    ...
    protected function addActionsGrid(ListMapper $listMapper)
    {
        $listMapper
            ->add('_action', 'actions', array(
                'actions' => array(
                    'edit' => array('template' => 'FinanceiroBundle:Sonata/Empenho/Empenho/CRUD:list_action_reemitirAnulacaoEmpenho.html.twig'),
                )
            ))
        ;
    }
    ...
    public function getSaldosEmpenho()
    {
        ...
        ->getSaldosEmpenho(
            ...
            $this->getSubject()->getFkEmpenhoPreEmpenho()->getCgmBeneficiario()->getNumcgm(),
            $despesa['recurso'],
    ...
    public function preUpdate($object)
    {
        ...
        if ($anularEmpenho) {
            ...
            $container->get('session')->getFlashBag()->add('success', "Anular Empenho concluído com sucesso! ({$empenho})");
            
            (new RedirectResponse("/financeiro/empenho/reemitir-anulacao-empenho/list"))->send();
        } else {
            ...
            (new RedirectResponse("/financeiro/empenho/reemitir-anulacao-empenho/" . $compositeKey . "/edit"))->send();
        }
    }
}
