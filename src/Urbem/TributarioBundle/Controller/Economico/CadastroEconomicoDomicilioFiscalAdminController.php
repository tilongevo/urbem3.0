...
/**
 * Class CadastroEconomicoDomicilioFiscalAdminController
 * @package Urbem\TributarioBundle\Controller\Economico
 */
class CadastroEconomicoDomicilioFiscalAdminController extends CRUDController
{
    protected $em;
    ...
    public function alterarAction(Request $request)
    {
        ...
        if (!$cadastroEconomico || $baixaCadastroEconomico) {
