$(function () {
    ...
    function findDetalheParcela(params, detalhesDiv) {
        ...
        $.ajax({
            url: "/tributario/arrecadacao/consultas/consulta-arrecadacao/detalhe-parcela",
            method: "GET",
    ...
    function findDetalhamentoPorCredito(codLancamento, numeracao, codParcela, detalhesDiv) {
        ...
        $.ajax({
            url: "/tributario/arrecadacao/consultas/consulta-arrecadacao/detalhamento-por-credito",
            method: "GET",
