$(document).ready(function () {
    var agencia = $('.js-select-agencia'),
        banco = $('..js-select-banco');
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, item) {
                        agenciaSelect.append($('<option style="display:none"></option>').attr('value', item.num_agencia).text(item.num_agencia));
                    });
