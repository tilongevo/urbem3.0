...
class CadastroEconomicoEmpresaFatoAdmin extends AbstractSonataAdmin
{
    const MODULO = 14;
    const CADASTRO = 1;
    ...
    protected $baseRouteName = 'urbem_tributario_economico_cadastro_economico_empresa_fato';
    protected $baseRoutePattern = 'tributario/cadastro-economico/inscricao-economica/empresa-fato';
    protected $includeJs = [
        '/administrativo/javascripts/administracao/atributo-dinamico-component.js',
        '/tributario/javascripts/economico/empresa-fato.js',
    ];
    ...
    */
    ...
    public function createQuery($context = 'list')
    {
        ...
        $qb->join(
            ...
            'ef',
            'WITH',
            sprintf('%s.inscricaoEconomica = ef.inscricaoEconomica', $qb->getRootAlias())
        );
    ...
    protected function configureDatagridFilters(DatagridMapper $datagridMapper)
    {
        $datagridMapper
            ...
            ->add(
                'fkEconomicoCadastroEconomicoEmpresaFato.fkSwCgmPessoaFisica',
                'doctrine_orm_model_autocomplete',
                [
                    'label' => 'label.economicoCadastroEconomicoEmpresaFato.cgm',
                ],
                ...
                [
                    ...
                    'callback' => function (AbstractSonataAdmin $admin, $property, $value) {
                        ...
                        $qb->join("{$rootAlias}.fkEconomicoCadastroEconomicoEmpresaFatos", "fkEconomicoCadastroEconomicoEmpresaFatos");
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        ...
        $listMapper
            ->add('inscricaoEconomica', null, ['label' => 'label.economicoCadastroEconomico.codInscricao'])
            ->add('fkEconomicoCadastroEconomicoEmpresaFato.fkSwCgmPessoaFisica.numCgm', null, ['label' => 'label.economicoCadastroEconomicoEmpresaFato.cgm'])
            ->add('fkEconomicoCadastroEconomicoEmpresaFato.fkSwCgmPessoaFisica.fkSwCgm.nomCgm', null, ['label' => 'label.economicoCadastroEconomicoEmpresaFato.nomCgm'])
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        if ($id) {
            ...
            $fieldOptions['fkSwCgmPessoaFisica']['data'] = $cadastroEconomico->getFkEconomicoCadastroEconomicoEmpresaFato()->getFkSwCgmPessoaFisica();
    ...
    protected function configureShowFields(ShowMapper $showMapper)
    {
        ...
        foreach ($this->atributos as &$atributo) {
            $atributoEmpresaFato = $em->getRepository(AtributoEmpresaFatoValor::class)->findOneBy(
                [
            ...
            $atributo['value'] = '';
            if (!$atributoEmpresaFato) {
                continue;
            }

            $atributo['value'] = $atributoEmpresaFato->getValor();
            if (!empty($atributo['parameters']['choices']) && !empty($atributoEmpresaFato->getValor())) {
                $atributo['value'] = array_flip($atributo['parameters']['choices'])[$atributoEmpresaFato->getValor()];
            }
        }
        ...
        $fieldOptions['cadastroEconomico'] = [
            'mapped' => false,
            'label' => false,
            'template' => 'TributarioBundle::Economico/CadastroEconomico/cadastro_economico_empresa_fato_show.html.twig',
        ];
    ...
    */
    protected function populateObject($object)
    {
        ...
        $empresaFato = $object->getFkEconomicoCadastroEconomicoEmpresaFato() ?: new CadastroEconomicoEmpresaFato();
        $empresaFato->setFkSwCgmPessoaFisica($form->get('fkEconomicoCadastroEconomicoEmpresaFato__fkSwCgmPessoaFisica')->getData());
        $empresaFato->setFkEconomicoCadastroEconomico($object);
        ...
        foreach ($empresaFato->getFkEconomicoAtributoEmpresaFatoValores() as $atributoEmpresaFato) {
            $empresaFato->removeFkEconomicoAtributoEmpresaFatoValores($atributoEmpresaFato);
        }
        ...
        foreach ($this->getRequest()->get('atributoDinamico') as $codAtributo => $atributo) {
            ...
            $atributoEmpresaFato = new AtributoEmpresaFatoValor();
            $atributoEmpresaFato->setValor($value);
            $atributoEmpresaFato->setFkAdministracaoAtributoDinamico($atributo);
            $empresaFato->addFkEconomicoAtributoEmpresaFatoValores($atributoEmpresaFato);
        }

        $object->setFkEconomicoCadastroEconomicoEmpresaFato($empresaFato);
    }
