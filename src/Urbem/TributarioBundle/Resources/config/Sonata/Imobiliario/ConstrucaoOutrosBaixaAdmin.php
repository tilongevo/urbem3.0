...
class ConstrucaoOutrosBaixaAdmin extends AbstractAdmin
{
    protected $baseRouteName = 'urbem_tributario_imobiliario_construcao_baixa';
    protected $baseRoutePattern = 'tributario/cadastro-imobiliario/construcao-baixa';
    ...
    public function prePersist($construcao)
    {
        ...
        try {
            ...
            $container->get('session')->getFlashBag()->add('success', $this->getTranslator()->trans('label.imobiliarioConstrucao.msgBaixarConstrucao', ['%codConstrucao%' => $construcao->getCodConstrucao()]));
