...
class ConstrucaoOutrosReativacaoAdmin extends AbstractAdmin
{

    protected $baseRouteName = 'urbem_tributario_imobiliario_construcao_reativacao';
    protected $baseRoutePattern = 'tributario/cadastro-imobiliario/construcao-reativacao';
    ...
    public function prePersist($construcao)
    {
        ...
        try {
            ...
            if ($construcao->getFkImobiliarioUnidadeDependentes()->count()) {
                ...
                $baixaUnidadeDependente = $construcao->getFkImobiliarioUnidadeDependentes()->last()->getFkImobiliarioBaixaUnidadeDependentes()->last();
            ...
            $container->get('session')->getFlashBag()->add('success', $this->getTranslator()->trans('label.imobiliarioConstrucao.msgReativarConstrucao', ['%codConstrucao%' => $construcao->getCodConstrucao()]));
