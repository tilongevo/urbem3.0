...
class ConstrucaoCaracteristicasAdmin extends AbstractAdmin
{
    protected $baseRouteName = 'urbem_tributario_imobiliario_edificacao_caracteristicas';
    protected $baseRoutePattern = 'tributario/cadastro-imobiliario/edificacao-caracteristicas';
    ...
    protected $includeJs = array(
        ...
        '/tributario/javascripts/imobiliario/edificacao-caracteristicas.js'
    );
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        if ($construcao) {
            ...
            $fieldOptions['codTipo']['data'] = $construcao->getFkImobiliarioConstrucaoEdificacoes()->last()->getCodTipo();
            ...
            foreach ($construcao->getFkImobiliarioConstrucaoProcessos() as $construcaoProcesso) {
                $listaProcessos[] = array(
                    ...
                    'atributoDinamico' => $construcaoModel->getNomAtributoValorByConstrucao($construcao, $construcaoProcesso->getTimestamp())
                );
            }
        }
    ...
    public function prePersist($construcao)
    {
        ...
        try {
            ...
            $construcaoModel->atributoDinamico($construcao->getFkImobiliarioConstrucaoEdificacoes()->last(), $this->request->request->get('atributoDinamico'), $dtAtual);
            ...
            $container->get('session')->getFlashBag()->add('success', $this->getTranslator()->trans('label.imobiliarioConstrucao.msgCaracteristicas', ['%codConstrucao%' => $construcao->getCodConstrucao()]));
