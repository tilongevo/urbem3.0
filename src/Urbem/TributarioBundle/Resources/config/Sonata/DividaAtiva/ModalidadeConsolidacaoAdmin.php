...
class ModalidadeConsolidacaoAdmin extends AbstractAdmin
{
    protected $baseRouteName = 'urbem_tributario_divida_ativa_modalidade_consolidacao';
    protected $baseRoutePattern = 'tributario/divida-ativa/modalidade/consolidacao';
    ...
    public function getSearchFilter($queryBuilder, $alias, $field, $value)
    {
        ...
        $modalidade = new ModalidadeConsolidacaoModel($this->getDoctrine());
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $model = new ModalidadeConsolidacaoModel($this->getDoctrine());
        $model->formMapperDadosParaModalidade(
            $formMapper,
            $this->getSubject(),
            sprintf('%s - %s', $this->getContainer()->get('translator')->transChoice('label.dividaAtivaModalidade.dadosParaModalidade', 0, [], 'messages'), $this->getContainer()->get('translator')->transChoice('label.dividaAtivaModalidade.consolidacao', 0, [], 'messages'))
        );
