...
class ConsultaISSArrecadacaoAdmin extends AbstractSonataAdmin
{
    protected $baseRouteName = 'urbem_portalservicos_arrecadacao_consulta_iss';
    protected $baseRoutePattern = 'portal-cidadao/arrecadacao/consulta/iss';
    ...
    */
    ...
    public function createQuery($context = 'list')
    {
        ...
        $qb->setParameter('descricao', sprintf('%%%s%%', 'iss'));
