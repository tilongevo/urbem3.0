(function ($, urbem) {
  ...
  $(document).on('show.bs.collapse', 'div[id^="accordion-historico-bem-"]', function (e) {
    var element = $(this)
    ...
    if (element.html().length === 0) {
      $.ajax({
        url: '/patrimonial/patrimonio/inventario/api/historico-bem/' + [indexes[3], indexes[4]].join('/'),
        data: { mode: 'table' },
        dataType: 'html',
        method: 'GET',
