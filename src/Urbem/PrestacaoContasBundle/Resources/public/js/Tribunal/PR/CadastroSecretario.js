$(document).ready(function() {
    ...
    $('button[name="filter"]').click(function() {
        ...
        // src/Urbem/PrestacaoContasBundle/Resources/views/Tribunal/PR/Configuracao/CadastroSecretario/main.html.twig
        ...
        $listagem.DataTable({
            ...
            // src/Urbem/PrestacaoContasBundle/Service/Tribunal/PR/Configuracao/ConfiguracaoCadastroSecretario.php::buildServiceProvider
            // src/Urbem/PrestacaoContasBundle/Service/Tribunal/PR/Configuracao/ConfiguracaoCadastroSecretario.php::actionLoadCadastroSecretario
            "ajax": {
                "url": url,
                "type": 'POST',
                "data": function (data) {
    ...
    $('a.new').click(function() {
        ...
        $.get(UrlServiceProviderTCE, data)
            .success(function (data) {
                modal.close().remove();
                modal.disableBackdrop().showCloseButton().setTitle('Dados para Cadastro do Secretário').setBody($(data.form)).open({'size': 'large'});
            })
            .error(function (data) {
                modal.close().remove();
            });
    ...
    $('body').on('click', '.remove-row', function() {
        ...
        data = [];
        data.push({name: 'action', value: 'RemoveConfiguracaoCadastroSecretario'});
        data.push({name: 'key', value: $(this).parent().find('input[name="key"]').val()});
