$(document).ready(function() {
    ...
    $('button[name="filter"]').click(function() {
        ...
        // src/Urbem/PrestacaoContasBundle/Resources/views/Tribunal/PR/Configuracao/BaixaResponsavelModulo/main.html.twig
        ...
        $listagem.DataTable({
            ...
            // src/Urbem/PrestacaoContasBundle/Service/Tribunal/PR/Configuracao/ConfiguracaoBaixaResponsavelModulo.php::buildServiceProvider
            // src/Urbem/PrestacaoContasBundle/Service/Tribunal/PR/Configuracao/ConfiguracaoBaixaResponsavelModulo.php::actionLoadResponsavelModulo
            "ajax": {
                "url": url,
                "type": 'POST',
                "data": function (data) {
    ...
    $('body').on('click', '.edit-row', function() {
        ...
        $.get(UrlServiceProviderTCE, data)
            .success(function (data) {
                modal.close().remove();
                modal.disableBackdrop().showCloseButton().setTitle('Dados para Baixa do Responsável do Módulo').setBody($(data.form)).open({'size': 'large'});
            })
            .error(function (data) {
                modal.close().remove();
            });
