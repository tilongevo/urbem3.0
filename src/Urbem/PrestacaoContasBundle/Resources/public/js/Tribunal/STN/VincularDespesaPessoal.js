$(document).ready(function() {
    ...
    $("#sonata-ba-field-container-total").after(areaSubmit);
    ...
    $(".money").keyup(function () {
        ...
        $(".bruto").each(function () {
            bruto += UrbemSonata.convertMoneyToFloat($(this).val());
        });
        $(".despesa").each(function () {
            despesa += UrbemSonata.convertMoneyToFloat($(this).val());
        });
        total = bruto - despesa;
