...
/**
 * Class ConfiguracaoAnexo3RCLCollectionType
 * @package Urbem\PrestacaoContasBundle\Service\Tribunal\STN\Form
 */
class ConfiguracaoAnexo3RCLCollectionType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('codTipo', 'prestacao_contas_stn_tipo_vinculo_stn_receita', [
