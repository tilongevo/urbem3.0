...
class ArquivosDisposicao extends ConfiguracaoAbstract implements ConfiguracaoInterface
{
    /**
     * @return array
     */
    ...
    public function processParameters()
    {
         try {
            ...
            $exercicio = $this->factory->getSession()->getExercicio();
             ...
             $this->processInformationByData($params, parent::PROCESS_DATE_TIME_FORMAT);
