...
/**
 * Class ArquivosPlanejamento
 * @package Urbem\PrestacaoContasBundle\Service\Tribunal\MG\Type\Sicom
 */
class ArquivosPlanejamento extends ConfiguracaoAbstract implements ConfiguracaoInterface
{
    /**
     * @return array
     */
     ...
     * @return array
     */
    public function buidServiceProvider(TwigEngine $templating = null)
    {
        return [
            'response' => true
        ];
