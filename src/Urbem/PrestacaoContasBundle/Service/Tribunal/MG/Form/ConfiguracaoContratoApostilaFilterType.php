...
class ConfiguracaoContratoApostilaFilterType extends AbstractType
{
    /**
     * @var SessionService
     */
    ...
    {
        /* gestaoPrestacaoContas/fontes/PHP/TCEMG/instancias/configuracao/FLManterApostilaContrato.php:68 */
        ...
        /* gestaoPrestacaoContas/fontes/PHP/TCEMG/instancias/configuracao/FLManterApostilaContrato.php:72 */
        $builder->add('nroContrato', TextType::class, [
            'label' => 'Número do Contrato'
        ]);

        /* gestaoPrestacaoContas/fontes/PHP/TCEMG/instancias/configuracao/FLManterApostilaContrato.php:86 */
        $builder->add('dataAssinatura', DatePickerType::class, [
            'label' => 'Data do Contrato'
        ]);

        /* gestaoPrestacaoContas/fontes/PHP/TCEMG/instancias/configuracao/FLManterApostilaContrato.php:93 */
        $builder->add('codApostila', TextType::class, [
            'label' => 'Número da Apostila'
        ]);
    }
