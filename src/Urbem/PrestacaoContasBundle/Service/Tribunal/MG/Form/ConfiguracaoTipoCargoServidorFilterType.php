 ...
 */
class ConfiguracaoTipoCargoServidorFilterType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('registros', DynamicCollectionType::class, [
            'dynamic_type' => ConfiguracaoTipoCargoServidorType::class,
            'label' => 'Informações do Tipo de Cargo do Servidor'
        ]);
    }
}