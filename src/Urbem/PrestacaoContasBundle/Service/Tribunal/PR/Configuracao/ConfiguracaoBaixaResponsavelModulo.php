...
use Urbem\PrestacaoContasBundle\Service\Tribunal\PR\Form\BaixaResponsavelModuloType;
use Urbem\PrestacaoContasBundle\Service\TribunalStrategy\ConfiguracaoAbstract;
use Urbem\PrestacaoContasBundle\Service\TribunalStrategy\ConfiguracaoInterface;
use Urbem\PrestacaoContasBundle\Service\TribunalStrategy\TceInterface;

final class ConfiguracaoBaixaResponsavelModulo extends ConfiguracaoAbstract implements ConfiguracaoInterface
{
    /**
     * @return array
     */
    ...
    {
        return [
            '/prestacaocontas/js/Tribunal/PR/BaixaResponsavelModulo.js',
        ];
    }
     ...
     *
     * called from src/Urbem/PrestacaoContasBundle/Resources/public/js/Tribunal/PR/BaixaResponsavelModulo.js
     ...
     *
     * called from src/Urbem/PrestacaoContasBundle/Resources/public/js/Tribunal/MG/BaixaResponsavelModulo.js (button new)
     * called from src/Urbem/PrestacaoContasBundle/Controller/TceAdminController.php
    ...
    public function actionLoadForm(TwigEngine $templating)
    {
        ...
        $form = $this->getFormFactory()
            ->create(
                BaixaResponsavelModuloType::class,
                $responsavelModulo,
                [
        ...
        if ('POST' === $this->getRequest()->getMethod()) {
            ...
            if (true === $form->isValid()) {
                ...
                if (null === $responsavelModulo->getCodResponsavel()) {
                    $message[] = 'Responsável Módulo não encontrado';
                }

                if (0 === count($message)) {
                    $message = 'Baixa de Responsável Módulo inserida com sucesso!';
        ...
        return [
            ...
            'form' => $templating->render(
                "PrestacaoContasBundle::Tribunal/PR/Configuracao/BaixaResponsavelModulo/form.html.twig",
                [
                    'form' => $formView,
                    'key' => $key,
                ]
    ...
    public function actionLoadResponsavelModulo()
    {
        ...
        foreach ($responsavelModuloList as $responsavelModulo) {
            ...
            // web/bundles/prestacaocontas/js/Tribunal/PR/BaixaResponsavelModulo.js (columnDefs)
        ...
        /* https://datatables.net/manual/server-side */
        /* items per page is set on src/Urbem/PrestacaoContasBundle/Resources/public/js/Tribunal/PR/BaixaResponsavelModulo.js (pageLength) */
        return [
    ...
    public function view(FormMapper $formMapper, TceInterface $objectAdmin)
    {
        ...
        $this->relatorioConfiguracao->setCustomBodyTemplate("PrestacaoContasBundle::Tribunal/PR/Configuracao/BaixaResponsavelModulo/main.html.twig");
