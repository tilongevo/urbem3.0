...
/**
 * Migration para mudar a coluna Timestamp das tabelas SwProcessoArquivado para DateTimeMicrosecondPk
 */
class Version20170117162838 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->changeColumnToDateTimeMicrosecondType(SwProcessoArquivado::class, 'timestamp_arquivamento');
