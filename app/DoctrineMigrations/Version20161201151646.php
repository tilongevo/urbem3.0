 ...
 */
class Version20161201151646 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    {
        $this->addSql('
        CREATE OR REPLACE FUNCTION contabilidade.relatorio_insuficiencia(character varying, character varying, character varying)
                        ...
                        INNER JOIN empenho.pre_empenho
                         ...
                         LEFT JOIN (  SELECT nota_liquidacao_item.exercicio
                                   ...
                                   LEFT JOIN (  SELECT exercicio
                                                 ...
                                                 WHERE TO_DATE(timestamp::varchar,\'\'yyyy-mm-dd\'\') <= TO_DATE(\'\'31/12/\'||stExercicio||\'\'\'::varchar,\'\'dd/mm/yyyy\'\')
                             ...
                             WHERE empenho.exercicio < \'\'\'||stExercicioAnterior||\'\'\'
                               ...
                               AND nota_liquidacao.dt_liquidacao <= TO_DATE(\'\'31/12/\'||stExercicio||\'\'\'::varchar,\'\'dd/mm/yyyy\'\')
                 ...
                 LEFT JOIN (  SELECT ( SUM(liquidacao_paga.vl_total) ) AS vl_pago
                          ...
                          INNER JOIN (  SELECT nota_liquidacao_paga.exercicio
                                          ...
                                          FROM (  SELECT nota_liquidacao_paga.exercicio
                                                   ...
                                                   WHERE TO_DATE(nota_liquidacao_paga.timestamp::varchar,\'\'yyyy-mm-dd\'\') <= TO_DATE(\'\'31/12/\'||stExercicio||\'\'\'::varchar,\'\'dd/mm/yyyy\'\')
                                     ...
                                     LEFT JOIN (  SELECT nota_liquidacao_paga_anulada.exercicio
                                                   ...
                                                   WHERE TO_DATE(nota_liquidacao_paga_anulada.timestamp_anulada::varchar,\'\'yyyy-mm-dd\'\') < TO_DATE(\'\'31/12/\'||stExercicio||\'\'\'::varchar,\'\'dd/mm/yyyy\'\')
                         ...
                         LEFT JOIN (  SELECT nota_liquidacao_item.exercicio
                                        ...
                                        FROM empenho.nota_liquidacao_item
                                             LEFT JOIN (  SELECT exercicio
                                                               ...
                                                               , SUM(COALESCE(vl_anulado,0.00)) AS vl_anulado
                                                            FROM empenho.nota_liquidacao_item_anulado
                                                           WHERE TO_DATE(timestamp::varchar,\'\'yyyy-mm-dd\'\') BETWEEN TO_DATE(\'\'01/01/\'||stExercicioAnterior||\'\'\'::varchar,\'\'dd/mm/yyyy\'\') AND TO_DATE(\'\'31/12/\'||stExercicio||\'\'\'::varchar,\'\'dd/mm/yyyy\'\')
                             ...
                             WHERE empenho.exercicio = \'\'\'||stExercicioAnterior||\'\'\'
                               ...
                               AND nota_liquidacao.dt_liquidacao BETWEEN TO_DATE(\'\'01/01/\'||stExercicioAnterior||\'\'\'::varchar,\'\'dd/mm/yyyy\'\') AND TO_DATE(\'\'31/12/\'||stExercicio||\'\'\'::varchar,\'\'dd/mm/yyyy\'\')
                               AND empenho.cod_entidade IN (\'||stCodEntidade||\')
                 ...
                 LEFT JOIN (  SELECT ( SUM(liquidacao_paga.vl_total) ) AS vl_pago
                          ...
                          INNER JOIN (  SELECT nota_liquidacao_paga.exercicio
                                          ...
                                          FROM (  SELECT nota_liquidacao_paga.exercicio
                                                       ...
                                                       , SUM(nota_liquidacao_paga.vl_pago) AS vl_total
                                                    FROM empenho.nota_liquidacao_paga
                                                   WHERE TO_DATE(nota_liquidacao_paga.timestamp::varchar,\'\'yyyy-mm-dd\'\') BETWEEN TO_DATE(\'\'01/01/\'||stExercicioAnterior||\'\'\'::varchar,\'\'dd/mm/yyyy\'\') AND TO_DATE(\'\'31/12/\'||stExercicio||\'\'\'::varchar,\'\'dd/mm/yyyy\'\')
                                                     AND nota_liquidacao_paga.cod_entidade IN (\'||stCodEntidade||\')
                                                GROUP BY nota_liquidacao_paga.exercicio
                                                       , nota_liquidacao_paga.cod_entidade
                                                       , nota_liquidacao_paga.cod_nota
                                     ...
                                     LEFT JOIN (  SELECT nota_liquidacao_paga_anulada.exercicio
                                                       ...
                                                       , SUM(COALESCE(nota_liquidacao_paga_anulada.vl_anulado,0.00)) AS vl_anulado
                                                    FROM empenho.nota_liquidacao_paga_anulada
                                                   WHERE TO_DATE(nota_liquidacao_paga_anulada.timestamp_anulada::varchar,\'\'yyyy-mm-dd\'\') BETWEEN TO_DATE(\'\'01/01/\'||stExercicioAnterior||\'\'\'::varchar,\'\'dd/mm/yyyy\'\') AND TO_DATE(\'\'31/12/\'||stExercicio||\'\'\'::varchar,\'\'dd/mm/yyyy\'\')
                                                     AND nota_liquidacao_paga_anulada.cod_entidade IN (\'||stCodEntidade||\')
                                                GROUP BY nota_liquidacao_paga_anulada.exercicio
                                                       , nota_liquidacao_paga_anulada.cod_entidade
                                                       , nota_liquidacao_paga_anulada.cod_nota
                    ...
                    FROM (  SELECT (  SUM(COALESCE(item_pre_empenho.vl_total,0.00))
                        ...
                        INNER JOIN empenho.item_pre_empenho
                         ...
                         LEFT JOIN (  SELECT empenho_anulado_item.exercicio
                                       ...
                                       WHERE TO_DATE(empenho_anulado_item.timestamp::varchar,\'\'yyyy-mm-dd\'\') <= TO_DATE(\'\'31/12/\'||stExercicio||\'\'\'::varchar,\'\'dd/mm/yyyy\'\')
                    ...
                    FROM (  SELECT (  SUM(COALESCE(item_pre_empenho.vl_total,0.00))
                        ...
                        INNER JOIN empenho.item_pre_empenho
                         ...
                         LEFT JOIN (  SELECT empenho_anulado_item.exercicio
                                           ...
                                           , SUM(empenho_anulado_item.vl_anulado) AS vl_anulado
                                        FROM empenho.empenho_anulado_item
                                       WHERE TO_DATE(empenho_anulado_item.timestamp::varchar,\'\'yyyy-mm-dd\'\') BETWEEN TO_DATE(\'\'01/01/\'||stExercicioAnterior||\'\'\'::varchar,\'\'dd/mm/yyyy\'\') AND TO_DATE(\'\'31/12/\'|| stExercicio||\'\'\'::varchar,\'\'dd/mm/yyyy\'\')
                                    GROUP BY empenho_anulado_item.exercicio
                                           , empenho_anulado_item.cod_pre_empenho
                                           , empenho_anulado_item.num_item
                                   ) AS empenho_anulado_item
                             ...
                             WHERE empenho.exercicio = \'\'\'|| stExercicioAnterior ||\'\'\'
                               AND empenho.dt_empenho BETWEEN TO_DATE(\'\'01/01/\'|| stExercicioAnterior||\'\'\'::varchar,\'\'dd/mm/yyyy\'\') AND TO_DATE(\'\'31/12/\'|| stExercicio||\'\'\'::varchar,\'\'dd/mm/yyyy\'\')
                               AND empenho.cod_entidade IN (\'|| stCodEntidade ||\')
                          GROUP BY pre_empenho.exercicio
                                 , pre_empenho.cod_pre_empenho
                                 , empenho.cod_entidade
    ...
    {
        $this->addSql('DROP FUNCTION contabilidade.relatorio_insuficiencia(character varying, character varying, character varying)');
    }
}
