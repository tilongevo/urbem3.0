 ...
 */
class Version20161027153719 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE OR REPLACE FUNCTION tesouraria.fn_listar_arrecadacao_tce(character varying, character varying)
                         RETURNS boolean
                         LANGUAGE plpgsql
                        AS $function$
                        DECLARE
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP FUNCTION tesouraria.fn_listar_arrecadacao_tce(character varying, character varying);');
    }
}
