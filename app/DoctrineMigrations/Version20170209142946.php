 ...
 */
class Version20170209142946 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->changeColumnToDateTimeMicrosecondType(Empenho::class, 'dt_empenho');
        $this->changeColumnToDateTimeMicrosecondType(Empenho::class, 'dt_vencimento');
        $this->addSql('
