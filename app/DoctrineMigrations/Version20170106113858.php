...
use Urbem\CoreBundle\Entity\Protocolo\ProcessoHistorico;
 ...
 */
class Version20170106113858 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP TRIGGER tr_atualiza_ultimo_andamento ON sw_andamento;');
        ...
        $this->changeColumnToDateTimeMicrosecondType(ProcessoDiasCadEcon::class, 'timestamp_proc');
        $this->changeColumnToDateTimeMicrosecondType(SwAndamento::class, 'timestamp');
        $this->changeColumnToDateTimeMicrosecondType(ProcessoHistorico::class, 'timestamp');
        ...
        $this->changeColumnToDateTimeMicrosecondType(ProcessoEmpDireitoNatJuridica::class, 'timestamp');
        $this->changeColumnToDateTimeMicrosecondType(ProcessoEmpDireitoNatJuridica::class, 'timestamp_proc');
        $this->changeColumnToDateTimeMicrosecondType(ProcessoDomicilioInformado::class, 'timestamp');
        $this->changeColumnToDateTimeMicrosecondType(ProcessoDomicilioInformado::class, 'timestamp_proc');
        $this->addSql('CREATE TRIGGER tr_atualiza_ultimo_andamento
              AFTER INSERT OR UPDATE
              ON sw_andamento
              FOR EACH ROW
              EXECUTE PROCEDURE fn_atualiza_ultimo_andamento();
        ');
        $this->addSql('
