 ...
 */
class Version20161108082258 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('
            CREATE OR REPLACE FUNCTION empenho.fn_consultar_valor_pagamento_anulado_nota(character varying, integer, integer)
             RETURNS numeric
             LANGUAGE plpgsql
            AS $function$
