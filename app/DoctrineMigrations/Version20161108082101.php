 ...
 */
class Version20161108082101 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('
            CREATE OR REPLACE FUNCTION empenho.fn_consultar_valor_liquidado_nota(character varying, integer, integer, integer)
             RETURNS numeric
             LANGUAGE plpgsql
            AS $function$
