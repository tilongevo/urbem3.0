 ...
 */
class Version20170531154741 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->changeColumnToDateTimeMicrosecondType(BaixaUnidadeAutonoma::class, 'timestamp');
        $this->changeColumnToDateTimeMicrosecondType(BaixaUnidadeDependente::class, 'timestamp');
        ...
        $this->insertRoute('urbem_tributario_imobiliario_edificacao_baixa_create', 'Baixar Edificação', 'tributario_imobiliario_edificacao_home');
        $this->insertRoute('urbem_tributario_imobiliario_edificacao_reativacao_create', 'Reativar Edificação', 'tributario_imobiliario_edificacao_home');
    }
