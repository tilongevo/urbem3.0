 ...
 */
class Version20161202093941 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    {
        $this->addSql('
            CREATE OR REPLACE FUNCTION contabilidade.excluiencerramentoanuallancamentosvariacoespatrimoniais2013(varexercicio character varying, intcodentidade integer)
             RETURNS void
             LANGUAGE plpgsql
            AS $function$
            DECLARE
    ...
    {
        $this->addSql('DROP FUNCTION contabilidade.excluiencerramentoanuallancamentosvariacoespatrimoniais2013(varexercicio character varying, intcodentidade integer)');
    }
}
