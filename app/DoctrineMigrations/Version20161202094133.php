 ...
 */
class Version20161202094133 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    {
        $this->addSql('
            CREATE OR REPLACE FUNCTION contabilidade.excluiencerramentoanuallancamentosorcamentario2013(varexercicio character varying, intcodentidade integer)
             RETURNS void
             LANGUAGE plpgsql
            AS $function$
            DECLARE
    ...
    {
        $this->addSql('DROP FUNCTION contabilidade.excluiencerramentoanuallancamentosorcamentario2013(varexercicio character varying, intcodentidade integer)');
    }
}
