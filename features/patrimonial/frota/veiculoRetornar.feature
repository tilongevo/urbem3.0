# features/patrimonial/frota/veiculoRetornar.feature
Feature: Homepage Patrimonial>Frota>Veiculo>Perfil>Retornar
  In order to Homepage Patrimonial>Frota>Veiculo>Perfil>Retornar
  ...
  Scenario: Create a new Veiculo with success
    ...
    And I fill field with uniqueId as "placa" with "rrr1234" when field is "input"
  ...
  Scenario: Add Retirar Veiculo with success
    ...
    And I fill in "filter_placa_value" with "rrr1234"
    And I press "search"
    And I follow "Perfil"
  ...
  Scenario: execute Retornar Veiculo with success
    Given I am on "/patrimonial/frota/veiculo/list"
    And I fill in "filter_placa_value" with "rrr1234"
    And I press "search"
    And I follow "Perfil"
    And I follow "Retornar"
    And I fill field with uniqueId as "kmRetorno" with "6500" when field is "input"
    And I press "Salvar"
    Then I should see "concluído com sucesso"
