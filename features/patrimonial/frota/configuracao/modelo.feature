# features/patrimonial/frota/configuracao/modelo.feature
Feature: Homepage Patrimonial>Frota>Configuracao>Modelo
  In order to Homepage Patrimonial>Frota>Configuracao>Modelo
