...
BACKUPDIR="/datacenter/www/longevo.com.br/datafiles/db"
...
then
	...
	then
		...
		echo "WARNING! - PostgreSQL Backup exceeds set maximum attachment size on $HOST - $DATE"
	fi
elif [ "$MAILCONTENT" = "log" ]
then
	echo "PostgreSQL Backup Log for $DBHOST - $DATE"
