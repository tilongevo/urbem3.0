   ...
   FROM ( SELECT tabela.cod_ordem,
           ...
           FROM ( SELECT op.cod_ordem,
                   ...
                   FROM (((((((((((((empenho.ordem_pagamento op
                     ...
                     JOIN public.sw_cgm cgm_pe ON ((pe.cgm_beneficiario = cgm_pe.numcgm)))
